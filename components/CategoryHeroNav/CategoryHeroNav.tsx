...
import {CategoryHeroNavFragment} from '@graphcommerce/magento-category/components/CategoryHeroNav/CategoryHeroNav.gql';
...
export function CategoryHeroNav({children, title, asset, description, sx = [] }: CategoryHeroNavProps) {
      ...
      sx={[
        (theme) => ({
          ...
          [theme.breakpoints.up('md')]: {
            ...
            gridTemplateRows: '0.3fr 0.7fr 1fr',
          },
        }),
