...
import { CmsRowSpecialBannerFragment } from './CmsRowSpecialBannerFragment.gql'

type RowSpecialBannerProps = CmsRowSpecialBannerFragment

export function CmsRowSpecialBanner(props: RowSpecialBannerProps) {
